...
class RoomsTodayListView(View):
    ...
    def post(self, request):
        ...
        if "search_by_day" in request.POST and request.POST.get("searched_day") is "":
            return render(
                request, "BookingRooms/app-rooms.html", {"object_list": object_list}
            )
        if (
            "search_by_day" in request.POST
            and request.POST.get("searched_day") is not ""
        ):
...
class RoomDetailsView(View):
    def get(self, request, id):
        ...
        return render(
            request,
            "BookingRooms/app-room-details.html",
...
class RoomAddView(View):
    ...
    def post(self, request):
        ...
        if not room_size or "" in (room_name, room_projector):
            return render(
                request,
                "BookingRooms/app-add-room.html",
                {
                    "room_name": room_name,
...
class RoomModifyView(View):
    def get(self, request, id):
        ...
        return render(
            request,
            "BookingRooms/app-modify-room.html",
            {
                "room_name": room.name,
...
class RoomBookView(View):
    ...
    def get(self, request, id, day=default_day):
        ...
        return render(
            request,
            "BookingRooms/app-room-book.html",
            {
                "room_name": room.name,
                "room_id": room.id,
                "day": day,
